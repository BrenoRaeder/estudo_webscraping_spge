...
#usando web driver para abrir e maximizar a páginadriver = webdriver.Chrome()
...
id_noticia, id_descricao, lista_noticias_banner, lista_descricao_noticias_banner = coleta_noticia_banner(id_noticia, id_descricao)
